...
class MainActivity : ComponentActivity() {
  ...
  private lateinit var wearablesPermissionRequester: WearablesPermissionRequester
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    wearablesPermissionRequester = WearablesPermissionRequester(this)
    ...
    viewModel.attachWearablesPermissionRequester(wearablesPermissionRequester)
