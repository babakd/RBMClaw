...
class SecurePrefs(context: Context) {
  ...
  private val _rbmEnabled = MutableStateFlow(prefs.getBoolean("rbm.enabled", false))
  val rbmEnabled: StateFlow<Boolean> = _rbmEnabled

  private val _rbmUseForTalkVision =
    MutableStateFlow(prefs.getBoolean("rbm.useForTalkVision", true))
  val rbmUseForTalkVision: StateFlow<Boolean> = _rbmUseForTalkVision

  private val _rbmHighResolution =
    MutableStateFlow(prefs.getBoolean("rbm.highResolution", false))
  val rbmHighResolution: StateFlow<Boolean> = _rbmHighResolution
  ...
  fun setRbmEnabled(value: Boolean) {
    prefs.edit { putBoolean("rbm.enabled", value) }
    _rbmEnabled.value = value
  }

  fun setRbmUseForTalkVision(value: Boolean) {
    prefs.edit { putBoolean("rbm.useForTalkVision", value) }
    _rbmUseForTalkVision.value = value
  }

  fun setRbmHighResolution(value: Boolean) {
    prefs.edit { putBoolean("rbm.highResolution", value) }
    _rbmHighResolution.value = value
  }
