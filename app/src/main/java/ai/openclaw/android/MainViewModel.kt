...
class MainViewModel(app: Application) : AndroidViewModel(app) {
  ...
  val rbmEnabled: StateFlow<Boolean> = runtime.rbmEnabled
  val rbmUseForTalkVision: StateFlow<Boolean> = runtime.rbmUseForTalkVision
  val rbmHighResolution: StateFlow<Boolean> = runtime.rbmHighResolution
  val rbmRegistrationState: StateFlow<RegistrationState> = runtime.rbmRegistrationState
  val rbmDevices: StateFlow<List<DeviceIdentifier>> = runtime.rbmDevices
  val rbmStreamState: StateFlow<StreamSessionState> = runtime.rbmStreamState
  ...
  fun attachWearablesPermissionRequester(requester: WearablesPermissionRequester) {
    runtime.attachWearablesPermissionRequester(requester)
  }

  fun setRbmEnabled(enabled: Boolean) {
    runtime.setRbmEnabled(enabled)
  }

  fun setRbmUseForTalkVision(enabled: Boolean) {
    runtime.setRbmUseForTalkVision(enabled)
  }

  fun setRbmHighResolution(enabled: Boolean) {
    runtime.setRbmHighResolution(enabled)
  }

  fun startRbmRegistration() {
    runtime.startRbmRegistration()
  }

  fun startRbmUnregistration() {
    runtime.startRbmUnregistration()
  }
